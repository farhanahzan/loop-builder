...
export const SectionOne = () => {
  return (
    <section className="relative max-w-2xl lg:max-w-[70rem] mx-auto px-6 lg:px-8 mt-16 py-10 lg:py-14 flex flex-col justify-center items-center lg:items-start ">
      <img
        className="h-56 md:h-72  lg:hidden"
        src={interactive}
        alt="Interactive"
      />
      <img
        className="w-full max-w-[45rem] hidden lg:block"
        src={interactive}
