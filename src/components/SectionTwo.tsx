  ...
  return (
    <section className="max-w-2xl lg:max-w-[70rem] mx-auto px-6 md:px-0 mt-16 py-10 flex flex-col justify-start items-center">
      <div className="pb-12 lg:pb-4 lg:px-8 lg:w-full lg:flex flex-row items-center justify-between ">
        ...
        <button className="text-sm font-alata uppercase  text-Black border-2 border-DarkGray px-8 py-2 my-8 tracking-widest hover:bg-Black hover:text-White hover:border-Black hidden lg:block">
          See All
        </button>
      </div>
      <div
      ...
      <button className="text-sm font-alata uppercase  text-Black border-2 border-DarkGray px-8 py-2 my-8 tracking-widest hover:bg-Black hover:text-White hover:border-Black lg:hidden">
        See All
      </button>
    </section>
  );
