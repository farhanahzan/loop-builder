...
export const MobileMenu = ({ onClose }: MobileMenuProps) => {
  return (
    <section className="fixed top-0 right-0 left-0  z-50   overflow-x-hidden overflow-y-hidden md:inset-0  md:h-full bg-Black h-screen flex flex-col justify-center items-start px-6 transition-all ease-in-out delay-150 duration-500 ">
      <div className="absolute top-0 left-0 right-0 w-full px-6 py-10  flex flex-row justify-between items-center">
        ...
        <img
          className="h-5 transition-all ease-in-out delay-150 duration-700 "
          src={close}
          alt="close"
          onClick={onClose}
        />
