  ...
  return (
    <div
      className={classNames+(
        'group relative max-w-sm md:max-w-[30rem]  lg:max-w-[15rem] h-32 lg:h-[21rem] w-full hover:font-semibold '
      )}
    >
      <div
        style={{ backgroundImage: `url(${image})` }}
        className="min-h-full rounded-md bg-cover bg-center lg:bg-top overflow-hidden bg-blend-overlay bg-[#00000069] drop-shadow-[0px_7px_5px_rgba(0,0,0,0.42)]     hover:blur-sm hover:bg-[#0a0a0a6b] "
      >
